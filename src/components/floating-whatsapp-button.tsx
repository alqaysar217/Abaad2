...
export function FloatingWhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[9999] flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-110 md:h-14 md:w-14"
